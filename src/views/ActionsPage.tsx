...
export const ActionMatinalesPage = () => {
  ...
  const recentMatinales = content.actions?.matinales?.recentMatinales || [];
      ...
      <div className="container" style={{ padding: '70px 40px' }}>
        ...
        <div style={{ textAlign: 'center', background: 'var(--atp-blue)', color: 'white', padding: '50px 40px', borderRadius: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/agenda" className="btn btn-primary">Consulter l'agenda</Link>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="page-root">
      ...
      <div className="container" style={{ padding: '70px 40px' }}>
        ...
        <div style={{ background: 'var(--light-gray)', padding: '40px', borderRadius: '20px', textAlign: 'center' }}>
          ...
          <img src="/region-grand-est-transparent.png" alt="Région Grand Est" style={{ height: '44px', width: 'auto', margin: '0 auto 12px', display: 'block', objectFit: 'contain' }} />
    ...
    <div className="page-root">
      ...
      <div className="container" style={{ padding: '70px 40px' }}>
        ...
        <div style={{ marginTop: '80px', marginBottom: '60px', textAlign: 'center' }}>
          ...
          <Link href="/organigramme" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
