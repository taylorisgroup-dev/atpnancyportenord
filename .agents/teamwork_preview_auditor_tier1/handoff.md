...
### Verification Method
1. View the file `c:\Users\admin\.gemini\antigravity\scratch\atp_nancy_nextjs\tests\e2e\tier1\5-cv-extraction-api.spec.ts`
2. Observe lines 45 and 66 where the status assertions explicitly allow `500` and `504`.
